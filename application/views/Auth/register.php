            ...
            <div class="form-group">
                ...
                <form action="<?php echo base_url('Auth/login')?>" method="POST" id="loginform" novalidate>
                    ...
                    <form action="<?php echo base_url('Auth/user');?>" method="POST" id="registerform">
                        ...
                        <?php echo form_input([ 'type'=>'text', 'name'=>'name'  , 'placeholder'=>'Enter full name' ,'value'=>set_value('name') ] );?>
                        ...
                        <?php echo form_input( [ 'type'=>'text', 'name'=>'username','placeholder'=>'Enter username' ,'value'=>set_value('username') ] );?>
